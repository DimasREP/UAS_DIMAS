                     ...
                     <div class="form-group">
                        <label for="exampleInputEmail1">Jenis kelamin</label>
                            ...
                            <label class="form-check-label">
                                <input type="radio" class="form-check-input" value="Laki-Laki" name="jenis_kelamin"  <?php if($jenis_kelamin=="Laki-Laki") echo "checked"  ?>>Laki Laki
                            </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" value="Perempuan" name="jenis_kelamin" <?php if($jenis_kelamin=="Perempuan") echo "checked"  ?>>Perempuan
                                </label>
                            </div> 
                            </div>
                    </div>
